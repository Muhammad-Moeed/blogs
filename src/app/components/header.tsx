...
<header className='flex shadow-md py-4 px-4 sm:px-10 bg-white font-[sans-serif] min-h-[70px] tracking-wide relative z-50'>
  <div className='flex flex-wrap items-center justify-between gap-5 w-full'>
    <Link href="javascript:void(0)"><Image src="/logo.png" width={400} height={400} alt="logo" className='w-20' />
    </Link>
    ...
    <div id="collapseMenu"
      ...
      <ul
        ...
        <li className='mb-6 hidden max-lg:block'>
          <Link href="javascript:void(0)"><Image src="https://readymadeui.com/readymadeui.svg" width={400} height={400} alt="logo" className='w-36' />
          </Link>
        </li>
