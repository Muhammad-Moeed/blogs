    ...
    <div className="max-w-screen-xl mx-auto">
        ...
        <main className="mt-10">
            ...
            <div className="mb-4 md:mb-0 w-full max-w-screen-md mx-auto relative" >
                ...
                ></div>
                <Image 
                className="w-full sm:w-full pl-10 pr-10"
                alt="typescipt" width={400} height={200} src="/typescript.jpg" />
                <div className="p-4 absolute bottom-0 left-0 z-20">    
                
                    <div className="flex ml-8 sm:mt-0 mt-10">
                        <Image alt="" src="/moeed.png" width={100} height={100}
                            className="h-10 w-10 rounded-full mr-2 object-cover" />
                        <div>
                            <p className="font-semibold text-gray-200 text-sm"> Muhammad Moeed </p>
                            <p className="font-semibold text-gray-400 text-xs"> 11 Oct </p>
                        </div>
                    </div>
                </div>
            </div>
